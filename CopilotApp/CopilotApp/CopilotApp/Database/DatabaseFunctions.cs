...
namespace CopilotApp
{
    public class DatabaseFunctions
    {
        ...
        public static void SendSensorData(string sensorID, string pressure, string temperature, string status, string remainingBattery, string companyID)
        {
            //dict["database_variable_name"] = value; // Only place filled in values in the dictionary
            Dictionary<string, string> dict = new Dictionary<string, string>();
        ...
        /*
        public static void SendMachineData(string machineID, double ambientTemp, double distanceDrivenEmpty, double distanceDrivenLoaded,
            int machineHoursEmpty, int machineHoursLoaded, double payloadTonnes, int payloadBuckets, double consumedFuel)
        {
            string sqlStatement =   "UPDATE tpms_vehicle SET " +
